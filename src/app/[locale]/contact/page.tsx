...
export default async function Contact({ params }: { params: Promise<{ locale: string }> }) {
    ...
    return (
        <div className="bg-white h-auto relative pb-[7rem] md:pb-[9rem]  mt-[98px]  sm:mt-[110px] md:mt-[115px] lg:mt-[100px] xl:mt-[110px] 2xl:mt-[120px]">
            ...
            <div className="container mx-auto flex lg:flex-row flex-col-reverse items-center gap-3 xl:gap-12 py-[3.5rem]">
                <div className="lg:w-1/2 w-full mt-8 lg:mt-0">
                    <iframe
                        ...
                        className="rounded-[10px] object-cover w-full filter object-center transition duration-200 mt-7 lg:mt-0"
                    ></iframe>
                </div>
